...
<head>
    ...
    <title>Forgot Password Basic - Pages | Materio - Bootstrap Material Design Admin Template</title>
    ...
    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="<c:url value="/assets/admin/vendor/css/pages/page-auth.css"/>" />
...
<div class="position-relative">
    <div class="authentication-wrapper authentication-basic container-p-y">
        <div class="authentication-inner py-4">
            ...
            <!-- /Forgot Password -->
            <img
                    src="<c:url value="/assets/admin/img/illustrations/tree-3.png"/>"
                    alt="auth-tree"
